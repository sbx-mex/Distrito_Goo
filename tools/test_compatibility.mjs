...
check('22. PWA sincronizada', sw.includes('distrito-go-') && sw.includes('v50.1.0-calendario-wfm-estable') && sw.includes('staleWhileRevalidate') && sw.includes('./styles/distrito-go.css') && sw.includes('./data/desarrollo-partner.v1.json') && sw.includes('./modules/search.js') && sw.includes('./modules/operations-center.js') && sw.includes('./modules/calendar.js'), 'caché WFM actualizado, módulo de calendario y CSS consolidado');
