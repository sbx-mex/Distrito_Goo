...
check('22. PWA sincronizada', sw.includes('distrito-go-') && sw.includes('v50.0.0-rendimiento-intuitivo') && sw.includes('staleWhileRevalidate') && sw.includes('./styles/distrito-go.css') && sw.includes('./data/desarrollo-partner.v1.json') && sw.includes('./modules/search.js') && sw.includes('./modules/operations-center.js'), 'caché v50 rápido y CSS consolidado');
