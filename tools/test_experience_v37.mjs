...
check('22. PWA sincronizada', sw.includes('distrito-go-') && sw.includes('v45.0.0-destinos-eventos') && sw.includes('./data/desarrollo-partner.v1.json') && sw.includes('./modules/search.js') && sw.includes('./modules/operations-center.js'), 'caché v45 aislado con destinos de Eventos validados');
