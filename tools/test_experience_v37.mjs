...
check('22. PWA sincronizada', sw.includes('distrito-go-') && sw.includes('v44.0.0-calendario-eventos-wfm') && sw.includes('./data/desarrollo-partner.v1.json') && sw.includes('./modules/search.js') && sw.includes('./modules/operations-center.js'), 'caché v44 aislado con calendario completo, WFM y Eventos');
