...
check('22. PWA sincronizada', sw.includes('distrito-go-') && sw.includes('v47.0.0-cms-sostenible') && sw.includes('./data/desarrollo-partner.v1.json') && sw.includes('./modules/search.js') && sw.includes('./modules/operations-center.js'), 'caché v47 aislado y CMS sostenible');
