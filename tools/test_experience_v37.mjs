...
check('22. PWA sincronizada', sw.includes('distrito-go-v39.0.0-buscador-cms-inventarios') && sw.includes('./data/desarrollo-partner.v1.json') && sw.includes('./modules/search.js'), 'caché v39 con búsqueda contextual');
