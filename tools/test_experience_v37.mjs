...
check('22. PWA sincronizada', sw.includes('distrito-go-') && sw.includes('v42.0.0-centro-operativo') && sw.includes('./data/desarrollo-partner.v1.json') && sw.includes('./modules/search.js') && sw.includes('./modules/operations-center.js'), 'caché v42 aislado con centro operativo');
