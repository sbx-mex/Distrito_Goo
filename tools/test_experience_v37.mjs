...
check('22. PWA sincronizada', sw.includes('distrito-go-') && sw.includes('v43.0.0-wfm-eventos-eco') && sw.includes('./data/desarrollo-partner.v1.json') && sw.includes('./modules/search.js') && sw.includes('./modules/operations-center.js'), 'caché v43 aislado con WFM y Eventos');
